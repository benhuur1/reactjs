...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220130_desenvolvedorweb_b1d31f3c08a3a6367894_20220130221723_archive.zip';
	const ARCHIVE_SIZE		 = '96370500';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'b1d31f3-30221723';
    const SECONDARY_PACKAGE_HASH = '669beaa-30221723';
	const VERSION			 = '1.4.3';
